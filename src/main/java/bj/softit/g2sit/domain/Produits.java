...
public class Produits implements Serializable {
    ...
    @NotNull
    @Column(name = "name_produit", nullable = false)
    ...
    public Produits nameProduit(String nameProduit) {
    ...
    public Produits reference(String reference) {
    ...
    public Produits etat(Etats etat) {
        this.etat = etat;
        return this;
    }

...
@Injectable()
export class HistoriquesResolvePagingParams implements Resolve<any> {
...
export const historiquesRoute: Routes = [
    {
        ...
        resolve: {
            'pagingParams': HistoriquesResolvePagingParams
        },
        data: {
            authorities: ['ROLE_USER'],
            pageTitle: 'g2SitApp.historiques.home.title'
        },

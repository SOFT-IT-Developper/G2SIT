...
public class StockResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_DATEENTRER = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATEENTRER = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final Boolean DEFAULT_RETOUR = false;
    private static final Boolean UPDATED_RETOUR = true;
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getDateentrer()).isEqualTo(DEFAULT_DATEENTRER);
        assertThat(testStock.isRetour()).isEqualTo(DEFAULT_RETOUR);
        assertThat(testStock.getComment()).isEqualTo(DEFAULT_COMMENT);
    ...
    public void getAllStocks() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateentrer").value(hasItem(sameInstant(DEFAULT_DATEENTRER))))
            .andExpect(jsonPath("$.[*].retour").value(hasItem(DEFAULT_RETOUR.booleanValue())))
    ...
    public void getStock() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks/{id}", stock.getId()))
            ...
            .andExpect(jsonPath("$.dateentrer").value(sameInstant(DEFAULT_DATEENTRER)))
            .andExpect(jsonPath("$.retour").value(DEFAULT_RETOUR.booleanValue()))
    ...
    public void updateStock() throws Exception {
        ...
        assertThat(testStock.getDateentrer()).isEqualTo(UPDATED_DATEENTRER);
        assertThat(testStock.isRetour()).isEqualTo(UPDATED_RETOUR);
        assertThat(testStock.getComment()).isEqualTo(UPDATED_COMMENT);

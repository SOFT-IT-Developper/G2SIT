...
import bj.softit.g2sit.repository.search.ProduitsSearchRepository;
...
import bj.softit.g2sit.domain.enumeration.Etats;
/**
...
public class ProduitsResourceIntTest {
    ...
    private static final String DEFAULT_NAME_PRODUIT = "AAAAAAAAAA";
    private static final String UPDATED_NAME_PRODUIT = "BBBBBBBBBB";
    ...
    private static final Etats DEFAULT_ETAT = Etats.BON;
    private static final Etats UPDATED_ETAT = Etats.REPARATION;
    ...
    public static Produits createEntity(EntityManager em) {
        Produits produits = new Produits()
            .nameProduit(DEFAULT_NAME_PRODUIT)
    ...
    public void createProduits() throws Exception {
        ...
        assertThat(testProduits.getNameProduit()).isEqualTo(DEFAULT_NAME_PRODUIT);
        assertThat(testProduits.getReference()).isEqualTo(DEFAULT_REFERENCE);
        ...
        assertThat(testProduits.getEtat()).isEqualTo(DEFAULT_ETAT);
    ...
    @Test
    @Transactional
    public void checkNameProduitIsRequired() throws Exception {
        int databaseSizeBeforeTest = produitsRepository.findAll().size();
        // set the field null
        produits.setNameProduit(null);
    ...
    public void getAllProduits() throws Exception {
        ...
        restProduitsMockMvc.perform(get("/api/produits?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameProduit").value(hasItem(DEFAULT_NAME_PRODUIT.toString())))
    ...
    public void getProduits() throws Exception {
        ...
        restProduitsMockMvc.perform(get("/api/produits/{id}", produits.getId()))
            ...
            .andExpect(jsonPath("$.nameProduit").value(DEFAULT_NAME_PRODUIT.toString()))
    ...
    public void updateProduits() throws Exception {
        ...
        updatedProduits
            .nameProduit(UPDATED_NAME_PRODUIT)
        ...
        Produits testProduits = produitsList.get(produitsList.size() - 1);
        assertThat(testProduits.getNameProduit()).isEqualTo(UPDATED_NAME_PRODUIT);
        assertThat(testProduits.getReference()).isEqualTo(UPDATED_REFERENCE);
        ...
        assertThat(testProduits.getEtat()).isEqualTo(UPDATED_ETAT);

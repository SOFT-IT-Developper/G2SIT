...
import bj.softit.g2sit.repository.CategorieRepository;
import bj.softit.g2sit.service.CategorieService;
import bj.softit.g2sit.repository.search.CategorieSearchRepository;
...
public class CategorieResourceIntTest {
    ...
    private static final String DEFAULT_NAME_CATEGORIE = "AAAAAAAAAA";
    private static final String UPDATED_NAME_CATEGORIE = "BBBBBBBBBB";
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .nameCategorie(DEFAULT_NAME_CATEGORIE)
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getFournisseur()).isEqualTo(DEFAULT_FOURNISSEUR);
    ...
    public void updateCategorie() throws Exception {
        ...
        updatedCategorie
            .nameCategorie(UPDATED_NAME_CATEGORIE)
        ...
        assertThat(testCategorie.getFournisseur()).isEqualTo(UPDATED_FOURNISSEUR);
